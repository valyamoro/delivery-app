...
return [
    ...
    'after' => 'Значение поля :attribute должно быть датой после текущего времени.',
    ...
    'attributes' => [
        ...
        'password' => 'пароль',
        'email' => 'почты',
        'data.*.courier_type' => 'типа курьера',
        'data.*.working_hours.*' => 'рабочих часов',
        'data.*.regions.*' => 'региона',
        'courier_type' => 'типа курьера',
        'working_hours.*' => 'рабочих часов',
        'regions.*' => 'региона',
        'data.*.region' => 'региона',
        'order_id' => 'идентификатора заказа',
